...
uint32_t DeviceManager::populate_pdev_info(const dev_info& dinfo, const iomgr::drive_attributes& attr,
    ...
    pinfo.data_offset = sisl::round_up(hs_super_blk::first_block_offset() + sb_size, 4096);
    LOGINFO("pdev {} aligned data offset {} offset {}", pinfo.pdev_id, pinfo.data_offset,
            hs_super_blk::first_block_offset() + sb_size);
